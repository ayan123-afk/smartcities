...
/* ----- Enhanced City Layout with Hospital and School ----- */
function CityLayout() {
  const buildings = [
...
/* ----- Enhanced Control Panel with Hospital and School Navigation ----- */
        ...
        <div style={{ maxHeight: '120px', overflowY: 'auto' }}>
          {Object.entries(locations).map(([name, pos]) => (
            <button 
              ...
              style={{ 
                width: '100%', 
                background: name.includes('Hospital') ? '#e74c3c' : 
                           name.includes('School') ? '#3498db' : 
                           name.includes('Garden') ? '#27ae60' : '#d2691e', 
                color: 'white', 
                border: 'none', 
                padding: '4px 6px', 
                borderRadius: '6px',
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ fontSize: 11, color: '#a67c52', marginTop: 4 }}>
          🌟 Features: Modern Hospital • Glass School • Cultural Center • Tech Hub
        </div>
        <div style={{ fontSize: 11, color: '#e74c3c', marginTop: 2, fontWeight: 'bold' }}>
          🏥 NEW: Modern Hospital with emergency services & wheelchair accessibility!
        </div>
        <div style={{ fontSize: 11, color: '#3498db', marginTop: 2, fontWeight: 'bold' }}>
          🏫 NEW: Glass School with full inclusivity for disabled students!
        </div>
